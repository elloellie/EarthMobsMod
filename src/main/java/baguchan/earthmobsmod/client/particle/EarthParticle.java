...
@OnlyIn(Dist.CLIENT)
abstract class EarthParticle extends TexturedParticle implements IParticleRenderType {
	protected EarthParticle(World world, double x, double y, double z) {
		super(world, x, y, z);
	}

	protected EarthParticle(World world, double x, double y, double z, double motionX, double motionY, double motionZ) {
