...
public class RainbowSheepModel<T extends RainbowSheepEntity> extends QuadrupedModel<T> {
    ...
    public RainbowSheepModel() {
        ...
        leg3.setTextureOffset(0, 32).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.0F, false);
