...
public class ModdedLakeFeature extends Feature<LakesConfig> {
    private static final BlockState AIR = Blocks.CAVE_AIR.getDefaultState();

    public ModdedLakeFeature(Function<Dynamic<?>, ? extends LakesConfig> p_i51485_1_) {
        super(p_i51485_1_);
    }
    ...
    public boolean place(IWorld worldIn, ChunkGenerator<? extends GenerationSettings> generator, Random rand, BlockPos pos, LakesConfig config) {
        if (worldIn.getWorld().getDimension().getType() != DimensionType.OVERWORLD) {
            return false;
        }
